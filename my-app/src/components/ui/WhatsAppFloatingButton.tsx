...
export function WhatsAppFloatingButton({ 
  ...
  return (
    <div className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-50">
      {/* Tooltip/Mensaje - Solo en desktop */}
      <div
        className={`hidden md:block absolute bottom-16 right-0 mb-2 transition-all duration-300 ${
        ...
        <div className="bg-white rounded-lg shadow-lg border p-3 max-w-xs">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm font-semibold text-gray-800">
              ¿Quieres información sobre un producto?
            </span>
          </div>
      ...
      <button
        ...
        className="group relative flex items-center justify-center w-12 h-12 md:w-14 md:h-14 bg-green-500 hover:bg-green-600 active:bg-green-700 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 active:scale-95 focus:outline-none focus:ring-4 focus:ring-green-300"
